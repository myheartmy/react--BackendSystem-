...
const CharacterListTable: React.FC<{}> = function CharacterListTable() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: '',
      key: 'x',
      render: () => <span className="handle"><Link to="/setting/staff/staffEdit">编辑</Link><Popconfirm placement="left" title="删除后无法恢复,确定删除?" onConfirm={confirm} okText="确定" cancelText="取消">
